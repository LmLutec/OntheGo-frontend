        ...
        return(
            <div className="edit-truck">
                ...
                <form onSubmit={(event) => {this.handleSubmit(event)}}>
                    ...
                    <input onChange={ event => {this.handlePhoneNumber(event)}} type="text" id="begNum" value={this.state.numberParts.begNum} style={{ width: "25px" }} required/>-<input onChange={ event => {this.handlePhoneNumber(event)}} type="text" id="lastNum" value={this.state.numberParts.lastNum} style={{ width: "30px" }} required/><br/>
