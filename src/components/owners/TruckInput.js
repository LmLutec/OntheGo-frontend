            ...
            <div className="truck-input">
                ...
                <form onSubmit={(event) => {this.handleSubmit(event)}}>
                    ...
                    <label>Phone number</label>
                        (<input onChange={ event => {this.handlePhoneNumber(event)}} type="text" id="areaCode" value={this.state.numberParts.areaCode} style={{ width: "10px" }} required/>)
                    <input onChange={ event => {this.handlePhoneNumber(event)}} type="text" id="begNum" value={this.state.numberParts.begNum} style={{ width: "10px" }} required/> -
                    <input onChange={ event => {this.handlePhoneNumber(event)}} type="text" id="lastNum" value={this.state.numberParts.lastNum} style={{ width: "10px" }} required/><br/>
